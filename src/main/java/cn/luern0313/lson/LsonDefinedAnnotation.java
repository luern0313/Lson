 ...
 *
 * <p>开发者需要创建一个类，并实现接口{@link Deserialization.LsonAnnotationListener}，在程序开始时
 * 通过静态方法{@link LsonUtil#setLsonAnnotationListener(Deserialization.LsonAnnotationListener)}
 * 传入该类的实例。
 *
