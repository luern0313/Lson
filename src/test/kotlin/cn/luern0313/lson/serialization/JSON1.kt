 ...
 */
object JSON1: SerializationJSONChecker<JSON1.FeedItemModel> {
    ...
    override fun check(lsonElement: LsonElement) {
        ...
        assertEquals(lsonElement["user"].asLsonObject["user_id"].asLsonPrimitive.asString, "100002")
        assertEquals(lsonElement["user"].asLsonObject["user_name"].asLsonPrimitive.asString, "陪你聊电影")
